...
export const logEntries: LogEntry[] = [
  {
    ...
    integrationName: 'Shopify',
    logo: '🛍️',
    apiEndpoint: 'Orders API → Hopstack Orders',
    status: 'success',
    recordsProcessed: 25,
    totalRecords: 25,
    duration: 1243,
  ...
  },
  {
    ...
    integrationName: 'NetSuite',
    logo: '📊',
    apiEndpoint: 'Inventory API → Hopstack Inventory',
    status: 'failed',
    recordsProcessed: 0,
    totalRecords: 150,
    duration: 15002,
  ...
  },
  {
    ...
    integrationName: 'ShipStation',
    logo: '📦',
    apiEndpoint: 'Shipments API → Hopstack Fulfillments',
    status: 'partial',
    recordsProcessed: 47,
    totalRecords: 50,
    duration: 2567,
  ...
  },
  {
    ...
    integrationName: 'Amazon',
    logo: '📦',
    apiEndpoint: 'Products API → Hopstack Products',
    status: 'pending',
    recordsProcessed: 0,
    totalRecords: 200,
    duration: 0,
  },
  {
    ...
    integrationName: 'QuickBooks',
    logo: '💰',
    apiEndpoint: 'Invoices API → Hopstack Invoices',
    status: 'success',
    recordsProcessed: 42,
    totalRecords: 42,
    duration: 856,
  ...
  },
  {
    ...
    integrationName: 'FedEx',
    logo: '✈️',
    apiEndpoint: 'Shipping API → Hopstack Shipments',
    status: 'failed',
    recordsProcessed: 0,
    totalRecords: 30,
    duration: 2100,
